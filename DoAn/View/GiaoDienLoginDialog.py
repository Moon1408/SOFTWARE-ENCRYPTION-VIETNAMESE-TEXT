...
from GiaoDienSlideBarMenu import MyMainWindowSBM
...
class LoginDialog(QMainWindow, Ui_Dialog):
    ...
    def check_Account(self,us,ps):
        with open("D:/HUFLIT/Nam3/BMHTTT/DoAN/Data/account.txt", "r", encoding='utf-8') as file:
            for line in file:
                if line.strip() == us+","+ps:
                    return True
            return False
