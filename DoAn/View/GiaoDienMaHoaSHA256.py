...
from ThietKe.ThietKeMaHoaSHA256 import Ui_Form  
import mahoasha256 #???????????
from PyQt6.QtCore import pyqtSignal
#========================================================================================
class MyMHSHA256(QWidget, Ui_Form):#[2]???????????????????????
    ...
    def MaHoa(self):
        ...
        if not textpl:
            ...
            self.c = mahoasha256.MaHoaSha256(textpl) #gọi hàm mã hoá của đối tượng này
            self.txtCiphertext.setPlainText(self.c)
    def MoFile(self):
    ...
    def GhiFile(self):
        ...
        if filePath:
            ...
            msg.setIcon(QMessageBox.Icon.Question)
            msg.setWindowTitle("Thông báo")
            msg.setText("Lưu file mã hóa thành công!!!!")
            msg.setStyleSheet("QMessageBox { background-color: white; }")
            ret = msg.exec()
#========================================================================================
def main():
    app = QApplication(sys.argv)
    mainMyForm = MyMHSHA256()
    mainMyForm.show()
    sys.exit(app.exec())
#========================================================================================
