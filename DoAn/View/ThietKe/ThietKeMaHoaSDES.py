# Form implementation generated from reading ui file 'D:\HUFLIT\Nam3\BMHTTT\DoAn\View\ThietKe\ThietKeMaHoaSDES.ui'
#
...
"font: 12pt \"Times New Roman\";")
        ...
        self.label.setGeometry(QtCore.QRect(310, 0, 241, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
...
"font: 12pt \"Times New Roman\";")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Nhập nội dung cần mã hóa:"))
        self.label_3.setText(_translate("Form", "Nhập key (chuỗi ký tự):"))
        self.label.setText(_translate("Form", "Mã hóa SDES"))
        self.btnOpenFile.setText(_translate("Form", "Mở file"))
        self.btnSaveFile.setText(_translate("Form", "Lưu file"))
        self.btnMaHoa.setText(_translate("Form", "Mã hóa"))
        self.label_4.setText(_translate("Form", "Nội dung đã mã hóa:"))
